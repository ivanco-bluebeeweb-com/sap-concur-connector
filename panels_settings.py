"""Settings panel for SAP Concur Connector."""
from __future__ import annotations
from imperal_sdk import ui
from app import ext

@ext.panel("__sap_concur_settings", slot="center")
async def settings_panel(ctx) -> ui.UINode:
    disconnect_form = ui.Form(
        # id=sap_concur_form",
        submit_label="Disconnect Active Account",
        action=ui.Call("disconnect_sap_concur"),
        children=[
    ...
    return ui.Stack(
        children=[
            ui.Heading("SAP Concur Settings & Accounts", level=2),
