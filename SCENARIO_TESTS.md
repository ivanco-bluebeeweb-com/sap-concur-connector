# Plausible Scenario Tests (PST) — SAP Concur Connector
...
- `connect_sap_concur`: validated contract & error handling
- `list_connections`: validated contract & error handling
- `disconnect_sap_concur`: validated contract & error handling
