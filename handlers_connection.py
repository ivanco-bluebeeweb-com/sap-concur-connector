...
async def connect_sap_concur(ctx, params: ConnectParams) -> ActionResult[ConnectionRecord]:
...
async def disconnect_sap_concur(ctx, params: ConnectionIdParams) -> ActionResult[DeleteResult]:
